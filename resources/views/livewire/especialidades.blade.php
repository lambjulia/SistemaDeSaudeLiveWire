                                        ...
                                        @foreach ($especialidades as $e)
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <button class="btn btn-sm btn-primary" wire:click="edit({{ $e->id }})">Editar</button>
                                                    <button class="btn btn-sm btn-danger" wire:click="deleteConfirmation({{ $e->id }})">Deletar</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                            <td colspan="4" style="text-align: center;"><small>Nenhum especialidade cadastrada</small></td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
                    ...
                    <div class="modal-body">
                        ...
                        <form wire:submit.prevent="store">
                            ...
                            <div class="form-group row">
                                <label for="nome_especialidade" class="col-3">Nome</label>
                                <div class="col-9">
                                    <input type="text" id="nome_especialidade" class="form-control" wire:model="nome_especialidade">
